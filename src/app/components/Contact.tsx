  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-6 text-center ">
        ...
        <div className="md:flex justify-between md:px-24 items-center">
          <div className="space-y-2 md:space-y-6">
            <p className="text-md md:text-lg">
              <a href="mailto:bhumisaxena0223@gmail.com" className="text-purple-500 hover:underline">
                📧 bhumisaxena0223@gmail.com
              </a>{" "}
              <br />
              📱{" "}
              <a href="tel:+919783302312" className="text-purple-500 hover:underline">
                +91 97833 02312
              </a>
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center space-x-6 ">
              <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-3 rounded-md hover:bg-gray-700">
              ...
              <a href="https://github.com/bhumisaxena0223" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-3 rounded-md hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://linkedin.com/in/bhumi-saxena-005ba9152" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-3 rounded-md hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <p>Feel free to schedule a meeting with me using the button below:</p>
            {/* Calendly Badge */}
            <CalendlyBadge />
            <button className="px-6 py-2 mt-2 bg-purple-500 hover:bg-purple-600 text-white rounded-full font-bold" onClick={handleClick}>
